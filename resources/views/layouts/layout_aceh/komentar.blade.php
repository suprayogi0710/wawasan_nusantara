        ...
        <div class="card">
                                ...
                                <div class="flex-grow-1 flex-shrink-1">
                                    <div>
                                        <div style="text-align: left">
                                            ...
                                            <p id="{{ $firstLevelComment->id }}" class="small text-black-50 my-3"
                                                style="text-align: left;">
                                                {{ $firstLevelComment->comment }}
                                            </p>

                                            <div class="small d-flex justify-content-start">
                                                <a id="saveLikeDislike" data-type="like"
                                                    data-province="{{ $firstLevelComment->province_id }}"
                                                    data-comment="{{ $firstLevelComment->id }}"
                                                    class="d-flex align-items-center me-3" role="button">
                                                    <i id="{{ $firstLevelComment->id }}-like"
                                                        class="far fa-thumbs-up me-2"></i>
                                                    <span class="{{ $firstLevelComment->id }}-like">
                                                        {{ $firstLevelComment->like }}
                                                    </span>
                                                </a>
                                                <a id="saveLikeDislike" data-type="dislike"
                                                    data-province="{{ $firstLevelComment->province_id }}"
                                                    data-comment="{{ $firstLevelComment->id }}"
                                                    class="d-flex align-items-center me-3" role="button">
                                                    <i id="{{ $firstLevelComment->id }}-dislike"
                                                        class="far fa-thumbs-down me-2"></i>
                                                ...
                                                <div>
                                                    <div style="text-align: left">
                                                        ...
                                                        <p id="{{ $secondLevelComment->id }}"
                                                            class="small text-black-50 my-3" style="text-align: left;">
                                                            {{ $secondLevelComment->comment }}
                                                        </p>

                                                        <div class="small d-flex justify-content-start">
                                                            <a id="saveLikeDislike"
                                                                class="d-flex align-items-center me-3" data-type="like"
                                                                data-province="{{ $secondLevelComment->province_id }}"
                                                                data-comment="{{ $secondLevelComment->id }}"
                                                                role="button">
                                                                <i id="{{ $secondLevelComment->id }}-like"
                                                                    class="far fa-thumbs-up me-2"></i>
                                                            ...
                                                            <a id="saveLikeDislike"
                                                                ...
                                                                data-type="dislike"
                                                                data-province="
                                                                {{ $secondLevelComment->province_id }}
                                                                "
                                                                data-comment="{{ $secondLevelComment->id }}"
                                                                role="button">
                                                                <i id="{{ $secondLevelComment->id }}-dislike"
                                                                    class="far fa-thumbs-down me-2"></i>
                                                                <span
                                                                    class="
                                                                {{ $secondLevelComment->id }}-dislike">
            ...
            <div class="card-footer py-3 border-0" style="background-color: #f8f9fa;">
                <form action="{{ url('comment/store') }}" method="post">
                    @csrf
                    <input type="number" name="province_id" hidden value="20">
                ...
                <div class="reply" style="display: none">
                    <form class="mb-2" method="post" id="formReply" role="form">
                        ...
                        <div class="d-flex flex-start mb-3 w-100">
                            <div class="form-outline w-100" style="text-align: left">
                                <input type="text" name="user_name_reply" id="user_name_reply"
