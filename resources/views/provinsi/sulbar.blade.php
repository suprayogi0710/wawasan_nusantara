            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p>Pantai Malalayang salah satu pantai di sulawesi barat</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="/assets/img/carausel/sumut_taman-nasional-bunaken.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Taman Nasional Bunake</h5>
                        <p>Taman Nasional Bunake salah satu taman disulawesi barat</p>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Pulau Mahoro</h5>
                        <p>Pulau Mahoro salah satu pulau di sulawesi barat</p>
                    </div>
                </div>
            </div>
    ...
    @section('content')
      ...
      <p>Makanan khas adalah sebuah makanan yang menjadi ciri khusus suatu daerah atau tempat, terutama
        daerah Nanggroe Aceh Darusallam yang memiliki beberapa ciri khas, antara lain.
            ...
            @include('layouts.layout_sulbar.makanan')<br>
            @include('layouts.layout_sulbar.pakaian')<br>
            @include('layouts.layout_sulbar.tari_daerah')<br>
            @include('layouts.layout_sulbar.tempat_wisata')
            @include('layouts.layout_sulbar.komentar')
        </div>
    @endsection
