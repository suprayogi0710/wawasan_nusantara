    ...
    @section('content')
      ...
      <p>Makanan khas adalah sebuah makanan yang menjadi ciri khusus suatu daerah atau tempat, terutama
        daerah Nanggroe Aceh Darusallam yang memiliki beberapa ciri khas, antara lain.
            ...
            @include('layouts.layout_sulteng.makanan')<br>
            @include('layouts.layout_sulteng.pakaian')<br>
            @include('layouts.layout_sulteng.tari_daerah')<br>
            @include('layouts.layout_sulteng.tempat_wisata')
            @include('layouts.layout_sulteng.komentar')
