...
function startTimer(){
    ...
    var timeInterval = setInterval(function(){
        ...
        if (minutes == 0 && seconds <= 0 || (questionIndex > totalQuestions-1)){
        ...
        timer.textContent = "Waktu : "+minutes+" menit : "+seconds+ " detik";
        time--;
...
quizContent.addEventListener("click",function(event){
    ...
    var userOption   = userAnswer.substring(3, userAnswer.length);
        ...
        if(userOption === ans){
            ...
            // jika salah, waktu akan dikurangi 10 detik
            // time -= 10;
...
function viewResult(){
    ...
    questionEl.innerHTML = "Kuis Selesai!";
    questionEl.style.display= "block";

    var s = document.createElement("p");
    s.textContent = "total jawaban yang benar : "+correct;
    scoreDiv.appendChild(s);

    var form = document.createElement("form");      //Create form for storing highscore

    var label = document.createElement("label");    //label
    label.textContent = "Masukkan nama : ";
...
function showHighScores(){
    ...
    questionEl.innerHTML = "Daftar Nilai Tertinggi";
    ...
    scoreDiv.style.display = "none";
        ...
        var headingText1 = document.createTextNode("Nama");
        ...
        var headingText2 = document.createTextNode("Skor");
        ...
        for (var i = 0; i < userLength ; i++) {
            ...
            var uscore = previousScores[i].score * 1/2;
    ...
    goback.textContent = "Kembali ke awal";
    ...
    clearscores.textContent = "Bersihkan skor";
